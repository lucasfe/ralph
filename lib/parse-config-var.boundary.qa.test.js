...
// still live in three other commands (cycle.js:190, status.js:379, doctor.js:160), and it reaches
...
describe('parseConfigVar — every spelling of a blank tail agrees (#147 QA)', () => {
  ...
  it('a blanked TASK_SOURCE parts the two shapes — presence keeps it, a `||` reaches past', async () => {
    ...
    // with `jsResolve`. The `||` row below is still shipped code — cycle.js:190, status.js:379 and
