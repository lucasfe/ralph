...
// lib/commands/start.js:277, and EVERY knob of the box reads through it — RALPH_AGENT (:347),
// GH_REPO (:1311), RALPH_CODEX_MODEL (:538), RALPH_CONTEXT_WINDOW (:544) and TASK_SOURCE (:510).
// Compared against
...
// still live in three other commands (cycle.js:194, status.js:384, doctor.js:160), and it reaches
...
// rather than left to be inferred. lib/commands/start.js:228-278 states the one rule and carries the
