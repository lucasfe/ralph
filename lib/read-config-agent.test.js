...
describe('parseConfigAgent — extract RALPH_AGENT from ralph.config.sh text', () => {
  ...
  it('tolerates the export prefix, a space-or-tab indent, and padding after the value', () => {
    ...
    // runs `codex` as a command and assigns nothing, and this reader now says nothing too.
    // Padding after the value is unaffected — that is padding bash really does drop.
