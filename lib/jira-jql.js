...
// matter) cannot drift if there is only one spelling of each.
export const JIRA_LABEL_EXCLUSION =
  `AND (labels NOT IN (${JIRA_IN_PROGRESS_LABEL}, ${JIRA_DONE_LABEL}, failed, do-not-ralph) OR labels IS EMPTY)`
