      ...
      cacheFs: Volume.fromJSON(
        {
          [CACHE_PATH]: JSON.stringify({
            ...
            // #215: the tap's own last answer, stamped as such. A bare number is readable by no
            // channel, so without this the throttled run would print nothing and the assertion
            // below would be measuring silence rather than a cheap notice.
