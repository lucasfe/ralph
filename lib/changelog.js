...
// opinion here is exactly what lib/banner-compose.js refuses to have. A file a human has
 ...
 * here — lib/banner-compose.js decides how many rows fit, because that is a question
 * about a box.
 *
...
// that prints it (lib/banner-compose.js's `textOr`) and a parser that quietly rewrote the
