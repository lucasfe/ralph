...
// lib/jira-jql.js reports as an empty query and counts as depth 0. And U+2028 is
// reachable by PASTING a query into `ralph init` (measured in lib/init.qa.test.js: real
// readline in terminal mode hands both separators back intact).
//
