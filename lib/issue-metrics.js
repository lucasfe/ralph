// Append-only writer for per-issue metrics, and the one guarded READ of the file
// it writes (`safeReadMetrics`, below). Each completed issue iteration appends ONE
...
export function safeReadMetrics(readFile, path) {
  try {
