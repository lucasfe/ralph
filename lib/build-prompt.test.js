...
describe('buildPrompt', () => {
  ...
  describe('jira task source selection (#128)', () => {
    ...
    it('tells the agent the ticket is already claimed and never to label it itself', () => {
      ...
      // The bash claimed it in #127, so no step may re-claim it, and completion
      // bookkeeping is a later slice — an edit here would be a board write nothing
      // else in the loop knows about.
