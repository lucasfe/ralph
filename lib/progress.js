...
export function buildProgress({ metricsText, record, queue, now, runAlive = true } = {}) {
...
// Shared by the live view's in-flight line and the report card's failed list (#59),
// where the padding is what makes `#034 #041` read as a column of task numbers.
