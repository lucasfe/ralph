...
//      for lib/banner-compose.js's stated reason, and the existing sweep contains none of them.
...
describe('QA #108 — what the denylist keeps, and what that looks like in the report', () => {
  // None of these is in `CONTROL`, and lib/banner-compose.js argues the omission: they REORDER
