...
import { renderDigest, runDigest } from '../digest.js'
// The flattener every line this shell writes goes through, asked of the module that owns it
// rather than of the engine next door (#108): it holds no digest state and imports nothing.
