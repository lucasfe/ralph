...
// start` users since #68 (see newerSentence in lib/banner-compose.js for the arithmetic). The
...
describe('QA #27 doctor takes NO network dependency — asserted on the import graph', () => {
  ...
  it('reaches neither install-target.js nor update.js — the two modules that shell out', () => {
    ...
    // constant at all (the hint is one sentence in lib/banner-compose.js), and the guard is
