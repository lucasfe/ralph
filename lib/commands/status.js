...
export async function collectStatus({
  ...
  // TASK_SOURCE: an eligibility query is a property of the repo, the template ships the
  // assignment empty, and `set -a` would put that empty value in the environment of every
  // child the loop spawns — so an env fallback would read as "unconfigured" in one process
  // and "configured" in the next.
