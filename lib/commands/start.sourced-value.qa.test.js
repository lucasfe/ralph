...
// TASK_SOURCE on a `||` (cycle.js:190, status.js:384, doctor.js:160 — all byte-identical to the
...
describe('QA #149 — the three commands still on a `||`, and what the difference costs', () => {
  ...
  it('PINNED DIVERGENCE: `ralph doctor` reports green where `ralph start` will abort', async () => {
    ...
    // of #149's scope and names status.js:384 and cycle.js:190 as the rest of the follow-up; what
