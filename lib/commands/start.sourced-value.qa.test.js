// QA augmentation for #149 — `sourcedValue` (lib/commands/start.js:298) attacked as a MATRIX
...
// (RALPH_CODEX_MODEL); the other four call sites — RALPH_AGENT (:368), TASK_SOURCE (:531),
// RALPH_CONTEXT_WINDOW (:565) and GH_REPO (:1355, through `bannerRepoSlug`) — are each pinned on a
...
// TASK_SOURCE on a `||` (cycle.js:194, status.js:384, doctor.js:208 — all byte-identical to the
