...
//                         `ralph stop` treats "nothing to kill" (stop.js:26-27). One line,
...
export async function liveCommand({
  ...
  if (!alive) {
    ...
    // own, which is what the ordering above is for. #168, moving the siblings onto this
    // module, is what actually closes the divergence.
    //
