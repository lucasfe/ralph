...
const ORPHAN_POINTERS = [
  ...
  // "...spawn `gh issue list --state all --label claude-working` (orphan-cleanup.js:N)"
  { needle: "await exec('gh', LIST_ARGS", claim: 'the list spawn' },
  // "...per orphan found, `gh issue edit N --remove-label claude-working` (orphan-cleanup.js:N)"
