...
// must spell that derived number. Nothing here restates 35, 39, 76, 113, 632, 654 or 662 — a
...
// was ever right.
//
// #141 IS THE SECOND TIME THIS FILE HAS EARNED ITS KEEP, and the first where it caught the drift
// rather than the dev. The migration warning made two edits to start.js: it grew one import line
// near the top into nine, and it added a 36-line block at step 7b. All four `./start.js:N`
// pointers in cycle.js went red at once, and all four moved by exactly eight lines — the amount
// the import grew by, and nothing else. The 36-line block shifted none of them because it sits
// BELOW all four. That is a fact about this one diff and not a rule, which is why the expected
// numbers are derived from needles instead of nudged by arithmetic. The start.js numbers listed
// in the paragraph above are the post-#141 values, quoted there only to name the numbers this
// file declines to depend on.
//
