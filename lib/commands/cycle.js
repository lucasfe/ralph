...
export async function cycleCommand({
  ...
  try {
    ...
    //
    // Unwrapped for the reasons at ./start.js:767-772, plus one that is only true
    ...
    if (updateGate.installed) {
      ...
      // an update (./start.js:789-796) because THIS process holds pre-update module
      ...
      // as ./start.js:797-807, and the gate is `installed` NEVER `to` — updateCommand
