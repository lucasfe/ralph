...
export async function cycleCommand({
  ...
  try {
    ...
    //
    // Unwrapped for the reasons at ./start.js:632-637, plus one that is only true
    ...
    if (updateGate.installed) {
      ...
      // an update (./start.js:654-661) because THIS process holds pre-update module
      ...
      // as ./start.js:662-673, and the gate is `installed` NEVER `to` — updateCommand
