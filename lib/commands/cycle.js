...
async function runPreflight({
  ...
  //            --state all --label claude-working` (orphan-cleanup.js:33) and, per orphan
  //            found, `gh issue edit N --remove-label claude-working`
  //            (orphan-cleanup.js:70). So the healthy steady state — no orphans — is TWO
  ...
  //            (orphan-cleanup.js:29), so a scheduled tick prints
