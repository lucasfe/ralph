...
export async function cycleCommand({
  ...
  try {
    ...
    //
    // Unwrapped for the reasons at ./start.js:760-765, plus one that is only true
    ...
    if (updateGate.installed) {
      ...
      // an update (./start.js:782-789) because THIS process holds pre-update module
      ...
      // as ./start.js:790-800, and the gate is `installed` NEVER `to` — updateCommand
