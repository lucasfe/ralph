...
export function buildPrompt({
  ...
  const vars = {
    ...
    // Absent for folder mode, jira mode and the validation prompt, all of which run
    // in the main tree; empty is treated as absent because bash exports an unset
    // variable as ''.
    // Read unconditionally, unlike RALPH_TASK_KEY above: only the github arm of
    // templates/ralph.sh exports it, and test/setup/hermetic-env.js neutralizes RALPH_*.
