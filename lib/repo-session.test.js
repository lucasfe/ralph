...
// it alive?". Two commands still ask it inline (status.js:318 and cycle.js:148), each with
// its own spelling of the root, and `ralph start` still keys its launch on the CWD
// (start.js:679) while `ralph cycle` keys on the git toplevel — two different sessions for
