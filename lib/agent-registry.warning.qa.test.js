...
describe('QA #108 — the structure that makes "one place, at the source" true', () => {
  ...
  it('names the whole set of modules that touch the warning: the resolver and its two printers', () => {
    ...
    // itself is in the list because it is where the warning is written. A fourth entry appearing
    // here is not a failure in itself; it is a demand that whoever added it also added a
    // line-count test for their printer.
    //
