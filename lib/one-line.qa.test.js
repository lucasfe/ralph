...
//      oversight. lib/banner-compose.js writes that argument out for the identity box's facts;
...
describe('QA #108 — what the denylist deliberately leaves alone, and whether that holds', () => {
  ...
  it('keeps every one of them, and not one of them can end a line', () => {
    // DOCUMENTED BEHAVIOUR, and the reasoning is lib/banner-compose.js's, checked rather than
