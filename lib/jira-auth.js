...
// acli" are different findings, and `reason` does not distinguish them either. Its
// one caller, lib/commands/doctor.js, therefore checks the seam BEFORE probing and
// renders the second case as "not verified"; do the same rather than reading an
// `ok: false` from here as a login failure.
//
