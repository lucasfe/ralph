...
// tag alongside the model and lib/banner-rows.js words the row differently for each. That
 ...
 * lib/banner-rows.js keys its wording on.
 *
 ...
 * at one and the argument for that is written in the module — so its SPECS hold the two
 * together: banner-rows.test.js for the row's wording and banner-compose.test.js for the
 * composed line, the same way that file holds SPRITE_MIN_WIDTH against the sprite.
 *
