...
const FAKE = vi.hoisted(() => {
  ...
  return {
    ...
    // would sail through a substitution that handed it the wrong container. No consumer reads it
    // yet — the migration warning is #141 — so the fake stays empty rather than inventing a
    // retired name that never existed.
