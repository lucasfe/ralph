...
// lib/banner-compose.js chose for the identity box's own facts, for the argument that module
...
describe('oneLineEcho — a value the user typed, echoed back safely (#108)', () => {
  ...
  it('replaces rather than strips, one code point in for one code point out', () => {
    // lib/banner-compose.js's argument, applied to a warning: `codx` with a NUL in the middle is
